...
session_start();
    ...
    // $nguoidung=
    function GuiMail( $clien_email,$gmail,$nd_mail,$td){   
        ...
        try {
            ...
            $mail->setFrom($clien_email, $nguoidung );   // địa chỉ mail của người gủi và tên người gủi
            $mail->addAddress('demowess@gmail.com', ''); //mail và tên người nhận  có thể để nhiều
